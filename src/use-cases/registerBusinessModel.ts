...
export class RegisterBusinessModelUseCase {
    constructor(private businessRepository: BusinessRepository, private businessModelRepository: BusinessModelRepository) {}

    public async execute({businessId, channels,costs,customerRelationship,customerSegments,mainActivities,mainPartnerships,mainResources,revenue,valueProposition}:RegisterBusinessModelRequest) {
